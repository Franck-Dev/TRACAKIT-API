 ...
 */
final class Version20220616143839 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE additional_material ADD outillage_moulage VARCHAR(255) DEFAULT NULL, DROP avion');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE additional_material ADD avion VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP outillage_moulage, CHANGE ref ref VARCHAR(22) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE designation designation VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE num_lot num_lot VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
