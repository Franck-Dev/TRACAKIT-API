 ...
 */
final class Version20220616073259 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE additional_material ADD avion VARCHAR(255) NOT NULL');
    }
